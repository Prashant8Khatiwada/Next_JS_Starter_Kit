...
import { Title, Paper, Text, Card, Group, Avatar, Badge, Loader } from "@mantine/core"
    ...
    <AuthGuard>
      <DashboardLayout>
        ...
        <Paper withBorder p="md" radius="md" mb="xl">
          <Text>
            This example demonstrates infinite scrolling using real data from JSONPlaceholder API. Scroll down to load
        ...
        <div className="space-y-4">
          {posts.map((post, index) => (
            <Card key={post.id} withBorder p="lg" radius="md" ref={index === posts.length - 1 ? lastItemRef : null}>
