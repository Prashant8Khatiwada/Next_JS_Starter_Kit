...
import { AlertCircle, Check, Search, RefreshCw, User, Users, Database, Server } from "lucide-react"
    ...
    <AuthGuard>
      <DashboardLayout>
        ...
        <Paper withBorder p="md" radius="md" mb="xl">
          <Text>
            This example demonstrates different approaches to API integration using TanStack Query (React Query) for
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <Paper withBorder p="xl" radius="md">
                  ...
                  <form onSubmit={handleSearch}>
                    ...
                    <Group position="apart">
                      ...
                      <Button variant="light" leftSection={<RefreshCw size={16} />} onClick={handleRefresh}>
                        Refresh
                      </Button>
                    </Group>
                  </form>
              ...
              <div className="md:col-span-2">
                {isUserLoading ? (
                          ...
                          <Card key={repo.id} withBorder p="md" radius="md">
                            <Group position="apart" mb="xs">
                              ...
                              <Group spacing={8}>
                                ...
                                <Badge color="blue">🍴 {repo.forks_count}</Badge>
                  ...
                  <Alert icon={<User size={16} />} title="No user selected" color="blue">
                    Enter a GitHub username and click Search to view user information.
                  </Alert>
                )}
              </div>
            </div>
          ...
          <Tabs.Panel value="mutation">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Paper withBorder p="xl" radius="md">
                ...
                <Text mb="lg">
                  This example demonstrates how to use mutations to create, update, or delete data. In this case, we're
              ...
              <Paper withBorder p="xl" radius="md">
                ...
                <Text mb="md">
                  Mutations are used to create, update, or delete data. Here's how to use mutations with TanStack Query:
                </Text>
        ...
        {mutation.isPending ? 'Creating...' : 'Create Todo'}
          ...
          <Tabs.Panel value="patterns">
            <Paper withBorder p="xl" radius="md">
              ...
              <Text mb="lg">
                Here are some common patterns and best practices for API integration in Next.js applications.
              </Text>

              <Accordion>
                <Accordion.Item value="setup">
                  <Accordion.Control>Setting up TanStack Query</Accordion.Control>
                  <Accordion.Panel>
                    <Text mb="md">
                      To set up TanStack Query in your Next.js application, you need to create a QueryProvider component
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <ReactQueryDevtools initialIsOpen={false} />
                    ...
                    <Text mt="md" mb="md">
                      Then, wrap your application with the QueryProvider in your layout or app component:
                    </Text>
        ...
        <QueryProvider>
          {children}
                ...
                <Accordion.Item value="api-client">
                  ...
                  <Accordion.Panel>
                    <Text mb="md">
                      It's a good practice to create a centralized API client for your application. This makes it easier
                      to handle authentication, error handling, and other common concerns.
                    </Text>
...
export default apiClient;`}
                ...
                <Accordion.Item value="custom-hooks">
                  ...
                  <Accordion.Panel>
                    <Text mb="md">
                      Create custom hooks for your API calls to encapsulate the logic and make it reusable across your
                      application.
                    </Text>
  ...
  return {
    ...
    deleteUser: deleteUserMutation.mutate,
                ...
                <Accordion.Item value="server-actions">
                  ...
                  <Accordion.Panel>
                    <Text mb="md">
                      In Next.js 14, you can use Server Actions to handle API calls directly from your components
    ...
    <form action={formAction}>
      ...
      {state.success && <p className="text-green-500">User created successfully!</p>}
                ...
                <Accordion.Item value="error-handling">
                  ...
                  <Accordion.Panel>
                    <Text mb="md">
                      Proper error handling is crucial for a good user experience. Here's how to handle errors with
                      TanStack Query:
                    </Text>
      ...
      {data.map(user => (
        <div key={user.id}>{user.name}</div>
                ...
                <Accordion.Item value="optimistic-updates">
                  ...
                  <Accordion.Panel>
                    <Text mb="md">
                      Optimistic updates improve the user experience by updating the UI before the server confirms the
                      change.
                    </Text>
