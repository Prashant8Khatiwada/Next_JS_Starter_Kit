    ...
    <AuthGuard>
      <DashboardLayout>
        ...
        <Paper withBorder p="md" radius="md" mb="xl">
          <Text>
            This example demonstrates various data visualization techniques using Recharts. You can switch between
            different chart types and data ranges.
          </Text>
        </Paper>
        ...
        <Paper withBorder p="md" radius="md" mb="xl">
          <Group position="apart">
            ...
            <Button leftSection={<RefreshCw size={16} />} variant="light" onClick={refreshData}>
              Refresh
            </Button>
          </Group>
        </Paper>
          ...
          <Grid.Col span={12} md={8}>
            <Paper withBorder p="md" radius="md" style={{ height: 400 }}>
              <Title order={4} mb="md">
                ...
                {dataKey === "value" ? "Revenue" : dataKey === "users" ? "Users" : "Sessions"}
              </Title>
