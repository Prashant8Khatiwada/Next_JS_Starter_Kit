...
import { Search, Filter, Plus, Edit, Trash, Eye, MoreHorizontal, MapPin, AtSign, Phone } from "lucide-react"
  ...
  return (
    <DashboardLayout>
            ...
            {displayedUsers.length === 0 ? (
              ...
              displayedUsers.map((user) => (
                <Table.Tr key={user.id}>
                  ...
                  <Table.Td>
                    <Group gap={4}>
                      <ActionIcon variant="subtle" color="blue" onClick={() => alert(`View user: ${user.name}`)}>
                        <Eye size={16} />
                      </ActionIcon>
                      ...
                      <Menu position="bottom-end" withinPortal>
                        ...
                        <Menu.Dropdown>
                          <Menu.Item onClick={() => alert(`Send email to: ${user.email}`)}>Send Email</Menu.Item>
                          <Menu.Item onClick={() => alert(`Reset password for: ${user.name}`)}>
                            Reset Password
                          </Menu.Item>
                        </Menu.Dropdown>
                      </Menu>
      ...
      <Group position="apart" mt="lg">
        ...
        <Pagination total={Math.ceil(filteredUsers.length / pageSize)} value={page} onChange={setPage} withEdges />
      </Group>
    </DashboardLayout>
  )
}
