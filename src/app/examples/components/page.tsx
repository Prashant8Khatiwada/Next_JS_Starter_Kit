  ...
  return (
    <DashboardLayout>
      ...
      <Paper withBorder p="md" radius="md" mb="xl">
        <Text>
          This page showcases various UI components available in this starter
          kit. These components are built with Mantine UI and enhanced with
          Tailwind CSS.
        </Text>
      </Paper>
      ...
      >
        ...
        <Paper withBorder p="lg" radius="md">
          ...
          <SimpleGrid cols={2} spacing="md">
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Text size="sm" mt="md">
                This is a simple card with a title and some content. You can use
            ...
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Divider my="sm" />
              <Text size="sm">
                This card shows a user profile with an avatar and some
        ...
        <Paper withBorder p="lg" radius="md">
          ...
          <Accordion>
            <Accordion.Item value="item1">
              ...
              <Accordion.Panel>
                This is a Next.js starter kit with Mantine UI, Tailwind CSS, and
                TanStack Query. It provides a solid foundation for building
            ...
            <Accordion.Item value="item2">
              ...
              <Accordion.Panel>
                You can customize the theme by modifying the tailwind.config.ts
                file and the globals.css file. You can also use Mantine's
                theming system to customize the components.
              </Accordion.Panel>
            </Accordion.Item>
            ...
            <Accordion.Item value="item3">
              ...
              <Accordion.Panel>
                Yes, this starter kit is completely free to use for both
                personal and commercial projects. You can modify it and use it
                as you wish.
              </Accordion.Panel>
            </Accordion.Item>
          </Accordion>
        ...
        <Paper withBorder p="lg" radius="md">
          ...
          <Alert
            ...
            mb="md"
          >
            Your action was completed successfully. Everything worked as
            expected.
          </Alert>
