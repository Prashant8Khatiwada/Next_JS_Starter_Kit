...
export default function FormValidationPage() {
  ...
  const form = useForm({
    ...
    validate: {
      ...
      terms: (value) =>
        value === false ? "You must accept the terms and conditions" : null,
    },
  });
    ...
    <AuthGuard>
      <DashboardLayout>
        ...
        <Paper withBorder p="md" radius="md" mb="xl">
          <Text>
            This example demonstrates form validation using Mantine's form
            library. It includes various validation rules and error handling.
          </Text>
        </Paper>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <Paper withBorder p="xl" radius="md" mb="lg">
              ...
              <Text mb="md">
                This section shows the current state of the form, including
