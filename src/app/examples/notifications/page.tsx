...
export default function NotificationsPage() {
  ...
  const form = useForm({
    initialValues: {
      ...
      message:
        "This is a notification message that will be displayed to the user.",
      color: "#228be6",
      position: "top-right",
      autoClose: 5000,
    ...
    <AuthGuard>
      <DashboardLayout>
        ...
        <Paper withBorder p="md" radius="md" mb="xl">
          <Text>
            This example demonstrates how to use Mantine's notification system
            to display various types of notifications to users.
          </Text>
        </Paper>
            ...
            >
              <Stack gap="md">
                ...
                <div>
                  ...
                  <Group align="center" mb="xs">
                    <Switch
                      ...
                      checked={autoClose}
                      onChange={(event) =>
                        setAutoClose(event.currentTarget.checked)
                      }
                    />
                  </Group>
                  {autoClose && (
                ...
                <Group>
                  ...
                  <Switch
                    label="With border"
                    {...form.getInputProps("withBorder", { type: "checkbox" })}
                  />
                </Group>
                ...
                <Button
                  ...
                  onClick={() =>
                    notifications.show({
                      ...
                      message:
                        "This is a default notification with no special styling",
                    })
                  }
                >
        ...
        <Paper withBorder p="xl" radius="md" mt="xl">
          ...
          <Alert
            ...
            title="How to use notifications in your code"
            color="blue"
            mb="md"
          >
            <Text mb="md">
              To use notifications in your application, you need to add the
              NotificationsProvider to your app and then use the notifications
              API.
            </Text>
