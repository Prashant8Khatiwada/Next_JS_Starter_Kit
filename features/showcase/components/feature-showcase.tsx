  ...
  return (
    <Card shadow="sm" padding="lg" radius="md" withBorder className="h-full">
      ...
      <Text size="sm" c="dimmed" className="mb-4">
        This component demonstrates the integration of Mantine UI components with Tailwind CSS classes. It also uses the
        Theme Context for state management.
      </Text>

      <Button variant="light" color="blue" fullWidth mt="md" radius="md" onClick={toggleTheme}>
